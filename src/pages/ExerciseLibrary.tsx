...
const ExerciseLibrary = () => {
  ...
  const freeExercises = [
    ...
    },
    {
      ...
      progression: "Add light weight (PVC pipe or dumbbell) for deeper stretch",
