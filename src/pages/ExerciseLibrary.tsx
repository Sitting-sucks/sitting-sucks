  ...
  const freeExercises = [
    {
      ...
      instructions: "Start in plank position with hands slightly wider than shoulders. Lower your body until chest nearly touches floor, then push back up. Keep neutral spine throughout movement.",
      equipment: ["None"],
      jointMovements: ["Shoulder Flexion", "Elbow Extension", "Shoulder Horizontal Adduction", "Thoracic Extension"],
      difficulty: 2,
      intensity: 3,
      duration: "30 seconds",
      hasVideo: true,
      ...
      targetMuscles: ["Pectoralis Major", "Anterior Deltoids", "Triceps Brachii", "Transverse Abdominis"],
      baseline: "Standard push-up from toes",
      progression: "Decline push-up with feet elevated on chair/box",
      regression: "Incline push-up with hands on chair/box",
    },
    {
      id: "2",
      name: "Squats",
      description: "Fundamental lower body movement pattern for functional strength",
      instructions: "Stand with feet shoulder-width apart. Lower your body by bending knees and pushing hips back. Keep chest up, neutral spine, and knees tracking over toes. Return to starting position.",
      equipment: ["None"],
      jointMovements: ["Ankle Dorsiflexion", "Knee Flexion", "Hip Flexion", "Lumbar Neutral"],
      difficulty: 1,
      intensity: 2,
      duration: "45 seconds",
      hasVideo: true,
