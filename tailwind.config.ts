		...
		extend: {
			...
			keyframes: {
				...
				'streak-fire': {
					...
					'25%': { transform: 'scaleY(1.1) scaleX(0.9)', filter: 'brightness(1.2)' },
					'50%': { transform: 'scaleY(0.95) scaleX(1.05)', filter: 'brightness(1)' },
					'75%': { transform: 'scaleY(1.05) scaleX(0.95)', filter: 'brightness(1.1)' }
				},
				'number-tick': {
